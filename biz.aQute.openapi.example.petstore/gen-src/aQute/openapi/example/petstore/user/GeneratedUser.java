...
/**
 * <ul>
 * <li>{@link #createUsersWithArrayInput(List<User>) POST /user/createWithArray
 ...
 * <li>{@link #getUserByName(String) GET /user/<b>[username]</b> =
 * getUserByName}
 * <li>{@link #updateUser(String,User) PUT /user/<b>[username]</b> = updateUser}
 * <li>{@link #createUser(User) POST /user = createUser}
 * <li>{@link #createUsersWithListInput(List<User>) POST /user/createWithList =
...
public abstract class GeneratedUser extends OpenAPIBase {
	...
	/**
	 * POST /user/createWithArray = createUsersWithArrayInput Creates list of
	 * users with given input array
	 * 
	 * @param body – List of user object (body) collectionFormat=%scsv
	 * @throws Response default / successful operation default
	 */

	protected abstract void createUsersWithArrayInput(List<User> body) throws Exception;

	/**
	 * GET /user/login = loginUser Logs user into the system
	 * 
	 ...
	 * @returns 400 / Invalid username/password supplied 200 X-Rate-Limit - int
	 *          X-Expires-After - java.time.Instant 400
	 */
	...
	/**
	 * GET /user/logout = logoutUser Logs out current logged in user session
	 * 
	 * @throws Response default / successful operation default
	 */
	...
	/**
	 * POST /user = createUser Create user This can only be done by the logged
	 * in user.
	 * 
	...
	/**
	 * POST /user/createWithList = createUsersWithListInput Creates list of
	 * users with given input array
	 * 
	 * @param body – List of user object (body) collectionFormat=%scsv
	 * @throws Response default / successful operation default
	...
	public GeneratedUser() {
		super(BASE_PATH, aQute.openapi.example.petstore.GeneratedBase.class,
				...
				"logoutUser           GET    /user/logout", "deleteUser           DELETE /user/{username}",
