...
public class JSONTest extends TestCase {
	...
	public void testGenerics() throws Exception {
		...
		Generics<String> b = (Generics<String>) codec.dec().from(string).get(new TypeReference<Generics<String>>() {
		}.getType());
	...
	public void testToDictionary() throws Exception {
		@SuppressWarnings("unchecked")
		Dictionary<String, String> dictionary = (Dictionary<String, String>) codec.dec()
				.from("{\"x\":3, \"y\":\"\"}")
	...
	public static void testDecodeBasic() throws Exception {
		...
		assertEquals(d, dec.from("\"2012-03-01T10:23:00Z\"").get(Date.class));
	...
	public static void testDefaults() throws Exception {
		Encoder enc = new JSONCodec().enc().writeDefaults(false);
