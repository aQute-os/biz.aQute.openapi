...
public class ItemsObject extends BaseOpenAPIObject {
	 ...
	 * a numeric instance. If the instance is a number, then this keyword
	 * validates if "exclusiveMaximum" is true and instance is less than the
	 * provided value, or else if the instance is less than or exactly equal to
	 * the provided value.
	 */
	public double			maximum				= Double.NaN;
	/**
	 * The value of "minimum" MUST be a number, representing a lower limit for a
	 * numeric instance. If the instance is a number, then this keyword
	 * validates if "exclusiveMinimum" is true and instance is greater than the
	 * provided value, or else if the instance is greater than or exactly equal
	 ...
	 * same as false. If "exclusiveMaximum" is true, then a numeric instance
	 * SHOULD NOT be equal to the value specified in "maximum". If
	 * "exclusiveMaximum" is false (or not specified), then a numeric instance
	 * MAY be equal to the value of "maximum".
	 */
	 ...
	 * same as false. If "exclusiveMinimum" is true, then a numeric instance
	 * SHOULD NOT be equal to the value specified in "minimum". If
	 * "exclusiveMinimum" is false (or not specified), then a numeric instance
	 * MAY be equal to the value of "minimum".
	 */
	public boolean			exclusiveMinimum	= false;

	/**
	 * The value of this keyword MUST be a non-negative integer. The value of
	 * this keyword MUST be an integer. This integer MUST be greater than, or
	 * equal to, 0. A string instance is valid against this keyword if its
	 * length is less than, or equal to, the value of this keyword. The length
	 * of a string instance is defined as the number of its characters as
	 ...
	 * 7159 [RFC7159]. The value of this keyword MUST be an integer. This
	 * integer MUST be greater than, or equal to, 0. "minLength", if absent, may
	 * be considered as being present with integer value 0.
	 */
	 ...
	 * numeric instance is only valid if division by this keyword's value
