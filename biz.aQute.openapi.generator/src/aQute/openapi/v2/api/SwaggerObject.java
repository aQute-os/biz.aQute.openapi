...
public class SwaggerObject extends BaseOpenAPIObject {
	...
	/**
	 * Security Definitions Object A declaration of the security schemes
	 * available to be used in the specification. This does not enforce the
	 * security schemes on the operations and only serves to provide the
	 * relevant details for each scheme.
	 */
