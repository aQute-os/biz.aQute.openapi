...
import biz.aQute.openapi.security.useradmin.basicauth.provider.BasicAuthenticationProvider.Hash;
...
@interface BasicAuthConfiguration {
	...
	String pwkey() default "aQute.ua.pw";
	...
	@AttributeDefinition(description = "Hashing algorithm to use for the stored passwords")
